...
# **function that can take in a player input and assign their marker as 'X' or 'O'.*while* loops to continually ask until we get a correct answer.**
...
# **function that asks for a player's next position (as a number 1-9) and then uses the function to check if its a free position. If it is, then return the position for later use. **
